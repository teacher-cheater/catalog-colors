...
//   const isCartVisible = cartModal.classList.toggle("modal-cart--visible");
...
// Остальные функции корзины (renderCartItems, addCartItemEventListeners и т.д.) остаются без изменений
// ...
...
function initDropdowns() {
  ...
  function closeDropdowns() {
    ...
    // Не скрываем оверлей, если открыта корзина
    if (
      !document
